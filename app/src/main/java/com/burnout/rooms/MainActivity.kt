        ...
        when (openedDialog) {
            ...
            1 -> {
                ...
                CustomDialog(
                    ...
                    enableConfirm = !(newName.isBlank() && newName.count() > nameLimit) && (newUserID.isBlank() && newUserID.count() > idLimit) && (newPassword.isBlank() && newPassword.count() > passwordLimit)
                ) {
                    Column {
                        // Set Display Name
                        OutlinedTextField(
